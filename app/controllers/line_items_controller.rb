class LineItemsController < ApplicationController
  ...
  def create
    ...
    if @line_item.save
      respond_to do |format|
        ...
        format.turbo_stream { flash.now[:notice] = "Item was updated" }
      end
    else
  ...
  def update
    if @line_item.update(line_item_params)
      respond_to do |format|
        format.html { redirect_to quote_path(@quote), notice: "Item was updated" }
        format.turbo_stream { flash.now[:notice] = "Item was updated" }
      end
    else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to quote_path(@quote), notice: "Item was destroyed" }
      format.turbo_stream { flash.now[:notice] = "Item was destroyed" }
    end
  end
